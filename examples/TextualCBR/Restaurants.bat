...
@echo ----------------------------
@echo jCOLIBRI Restaurants example
@echo ----------------------------

cd ..\..\src

@echo Compiling source code generated by jCOLIBRI
javac -classpath ..\libs\;..\bin\ -d ..\bin\ jcolibri\application\textualCBR\textExample.java
javac -classpath ..\libs\;..\bin\ -d ..\bin\ jcolibri\application\textualCBR\textualCBR.java
...
java -classpath %CLASSPATH% jcolibri.application.textualCBR.textExample
@pause
